...
public class SessionManager {
    ...
    private static final String KEY_CONCURSO = "marcadoresConcurso";
    ...
    public void setConcurso(int participaciones){
        editor.putInt(KEY_CONCURSO, participaciones);

        editor.commit();
    }

    public int getConcurso() {return pref.getInt(KEY_CONCURSO, 10);}
